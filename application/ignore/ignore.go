...
// https://github.com/sabhiram/go-gitignore/graphs/contributors
//
//
/*
...
// Compile accepts a ignore file as the input, parses the
// lines out of the file and invokes the CompileIgnoreLines method with
// additional lines.
func Compile(fpath string, lines ...string) *GitIgnore {
	...
	gi := CompileIgnoreLines(append(ignoreList, lines...)...)
	return gi
}
