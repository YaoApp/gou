...
// SafeExtractInt safely extracts int values from interface{} with type conversion
...
// SafeExtractFloat64 safely extracts float64 values from interface{} with type conversion
