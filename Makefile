...
TESTFOLDER := $(shell $(GO) list ./... | grep -E 'process|model|schema|lang|query|task|schedule|flow|session|store|fs|http|encoding|ssl|connector|wasm|websocket|v8' | grep -v -E 'wamr|socket')
TESTTAGS ?= ""
